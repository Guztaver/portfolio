...
export const translations: Translations = {
  ...
  pt: {
    ...
    content: {
      ...
      "about-content": {
        title: "👨‍💻 GUSTAVO MUNIZ - Desenvolvedor Java & Angular",
        content: [
          "Sou um desenvolvedor de software e um profundo entusiasta do ecossistema Java. Gosto muito de aprender e explorar tudo sobre o framework Spring. Também sou um grande fã de Angular e TypeScript/JavaScript, sempre visando criar sistemas altamente eficientes e que proporcionem uma ótima experiência ao usuário. Também sou um entusiasta apaixonado pelo mundo Linux!",
          "",
          "<span style='color: #00ff00'>🎯 Especializações:</span>",
          "  • Desenvolvimento com Java e Spring Boot",
          "  • Angular e Frameworks Frontend Modernos",
          "  • Arquitetura e Design de Sistemas",
          "  • Administração de Sistemas Linux",
          "  • Otimização de Performance",
          "",
          "<span style='color: #61dafb'>🌟 Áreas de Paixão:</span>",
          "  • Ecossistema do Framework Spring",
          "  • Programação Reativa em Java",
          "  • Frontend Escalável com Angular",
          "  • Código Limpo e Boas Práticas",
          "  • Resolução de Problemas e Open Source",
        ],
      },
      "experience-content": {
